...
<body style="background-color: gray;">
   ...
   <h1 style="margin-top: 200px;background-color: white;"> <marquee>Bienvenue dans G2 GL</marquee></h1>
   <br><br>
   <h3 style="color: white;" class="text-center">Khalifa Ababacar DIADHIOU</h3>
</body>
</html>